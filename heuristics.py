...
def evaluate_board(board):
    ...
    for square in chess.SQUARES:
        ...
        if piece is not None:
            ...
            # Positional bonus from tables (reversing index for black)
            idx = square
            if piece.color == chess.BLACK:
                # Mirroring for black: square index 0 becomes 56, etc.
                idx = chess.SQUARE_NAMES.index(chess.square_name(square ^ 56))
